...
function RowRiwayat({ jenjang, sekolah, tahun }: RowRiwayatProps) {
  return (
    <div className="border-2 border-blue-400/75 rounded-lg bg-gray-700 p-2 my-2">
      <div className="container mx-auto">
        <div className="grid grid-cols-12 gap-1">
          <div className="col-span-12 md:col-span-4">{jenjang}</div>
          <div className="col-span-12 md:col-span-4">{sekolah}</div>
